...
(function Tutorial$Members () {
  ...
  function Tutorial_Init () {
    ...
    expr_6E5.Albedo = $S00().Construct(0.9, 0.9, 0.1);
    expr_84[5] = expr_6E5;
  ...
  function Tutorial_LoadMesh (assetName) {
    ...
    if ((arg_2D_1 = $T11().$l$g9__18_0) === null) {
      arg_2D_1 = $T11().$l$g9__18_0 = $T0D().New($T11().$l$g9, null, new JSIL.MethodPointerInfo($asm09.Fusee.Tutorial.Core.Tutorial_$l$gc, "$lLoadMesh$gb__18_0", $S03(), false, false));
    }
  ...
  function Tutorial_RenderAFrame () {
    ...
    var key = $T19().get_Keyboard().GetKey($T1D().F);
    if (key) {
      var flag2 = this.direction;
      if (flag2) {
        this._legMovement = +this._legMovement + 0.025;
        this._armMovement = +this._armMovement + 0.025;
        if (+this._legMovement >= 0.6) {
    ...
    $thisType.FindSceneOb(this._root, "LeftShoulder").Rot.x = +this._armMovement * -1;
    $thisType.FindSceneOb(this._root, "RightShoulder").Rot.x = +this._armMovement;
    $thisType.FindSceneOb(this._root, "LeftThigh").Rot.x = +this._legMovement;
    $thisType.FindSceneOb(this._root, "RightThigh").Rot.x = +this._legMovement * -1;
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:false}, "_leftArmZ", $.Single);

    $.Field({Static:false, Public:false}, "_leftArmX", $.Single);

    $.Field({Static:false, Public:false}, "_rightArmZ", $.Single);

    $.Field({Static:false, Public:false}, "_rightArmX", $.Single);

    $.Field({Static:false, Public:false}, "_armMovement", $.Single);

    $.Field({Static:false, Public:false}, "_legMovement", $.Single);
...
(function $l$gc$Members () {
  ...
  function $l$gc_$lLoadMesh$gb__18_0 (c) {
    return true;
  }; 
  ...
  JSIL.MakeType({
    ...
    $.Method({Static:false, Public:false}, "$lLoadMesh$gb__18_0", 
      new JSIL.MethodSignature($.Boolean, [$asm07.TypeRef("Fusee.Serialization.MeshComponent")]), 
      $l$gc_$lLoadMesh$gb__18_0
    );

    $.Field({Static:true , Public:true , ReadOnly:true }, "$l$g9", $.Type);

    $.Field({Static:true , Public:true }, "$l$g9__18_0", $asm14.TypeRef("System.Predicate`1", [$asm07.TypeRef("Fusee.Serialization.MeshComponent")]));
